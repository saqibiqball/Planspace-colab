...
const UpdateRoomForm = ({ close, RoomValues, defaultVal }) => {
  console.log("edit room form => ", defaultVal, RoomValues);
  ...
  const formik = useFormik({
    initialValues: {
      ...
      base_price: defaultVal?.base_price,
      max_guests: defaultVal?.max_guests,
      image: new File([], ""),
      file: new File([], ""),
      options: {},
      id: defaultVal.id,
        ...
        <form onSubmit={formik.handleSubmit}>
          ...
          {active1 && (
            <TabDiv
              ...
              tabName={"Space"}
              options={spaces}
              selectedValues={defaultVal.spaces}
          ...
          {active2 && (
            <TabDiv
              ...
              tabName={"amenities"}
              options={amenities}
              selectedValues={defaultVal.amenities}
          ...
          {active3 && (
            <TabDiv
              setShowDropdown={setShowDropdown}
              showDropdown={showDropdown}
              tabName={"Ceremony Types"}
              options={ceremony_types}
              selectedValues={defaultVal.ceremony_types}
              values={(values) =>
                (formik.values.options.ceremony_types = values)
              }
            />
          )}
